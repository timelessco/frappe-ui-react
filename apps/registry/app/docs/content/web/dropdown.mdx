    ...
    <PackageManagerTabs defaultValue="npm">
      ...
      <TabsContent value="npm">
        <EnhancedCodeBlock language="bash">
          npx shadcn@latest add "https://frappe-ui-react.tmls.dev/registry/dropdown"
        </EnhancedCodeBlock>
      </TabsContent>
      <TabsContent value="pnpm">
        <EnhancedCodeBlock language="bash">
          pnpm dlx shadcn@latest add "https://frappe-ui-react.tmls.dev/registry/dropdown"
        </EnhancedCodeBlock>
      </TabsContent>
      <TabsContent value="yarn">
        <EnhancedCodeBlock language="bash">
          yarn shadcn@latest add "https://frappe-ui-react.tmls.dev/registry/dropdown"
        </EnhancedCodeBlock>
      </TabsContent>
    </PackageManagerTabs>
  </TabsContent>
