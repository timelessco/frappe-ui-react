...
import image from "./images/native-avatar.png"
...
<Image src={image} alt="Avatar" className="w-full rounded-lg shadow-lg" />
  ...
  <TabsContent value="cli">
    <PackageManagerTabs defaultValue="npm">
      ...
      <TabsContent value="pnpm">
        <EnhancedCodeBlock language="bash">
          pnpm dlx shadcn@latest add "https://frappe-ui-react.tmls.dev/registry/native-avatar"
        </EnhancedCodeBlock>
      </TabsContent>
      <TabsContent value="yarn">
        <EnhancedCodeBlock language="bash">
          yarn shadcn@latest add "https://frappe-ui-react.tmls.dev/registry/native-avatar"
        </EnhancedCodeBlock>
      </TabsContent>
    </PackageManagerTabs>
  </TabsContent>
