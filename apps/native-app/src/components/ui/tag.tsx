...
import { GestureResponderEvent, Pressable, PressableProps, Text, TextStyle } from 'react-native';
		...
		typeof children === 'string' ? (
			<Text
				className={cx(
					...
					disabled ? tagTheme.theme[themeColor]?.variant[variant]?.text?.disabled : ''
				)}
	...
	return (
		<AnimatedPressable
			...
			className={cx(
				...
				disabled ? tagTheme.theme[themeColor]?.variant[variant]?.container?.disabled : '',
				className
			)}
			{...otherProps}
			accessible
